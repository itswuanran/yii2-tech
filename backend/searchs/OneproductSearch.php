...
/**
 * OneproductSearch represents the model behind the search form about `common\models\Oneproduct`.
 */
class OneproductSearch extends Oneproduct
{
    /**
     * @inheritdoc
     */
